...
/**
 * SpaceInstanceTypesStatistics
 */
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2017-11-15T10:53:27.384Z")
public class SpaceInstanceTypesStatistics extends HashMap<String, SpaceTypeStatistics> {
  ...
  public String toString() {
    ...
    sb.append("class SpaceInstanceTypesStatistics {\n");
