...
import io.swagger.client.model.ReplicationChannelStatistics;
import java.util.HashMap;
import java.util.Map;

/**
 * replication channel statistics for each replication target
 */
@ApiModel(description = "replication channel statistics for each replication target")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2017-11-15T10:53:27.384Z")
public class ReplicationChannels extends HashMap<String, ReplicationChannelStatistics> {
  ...
  public String toString() {
    ...
    sb.append("class ReplicationChannels {\n");
